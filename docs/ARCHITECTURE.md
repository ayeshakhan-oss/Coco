...
│   ├── 03_warm-bench-feedback-email.md (extended version)
│   ├── 01_candidate-rejections.md (unique summary)
│   ├── hiring-pipeline-weekly-report.md (automation ref)
...
- 02_values-feedback-emails.md (duplicate of SOPs/01_Candidate_Communication/values_feedback_emails.md)
