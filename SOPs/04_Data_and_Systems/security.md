...
**Load this when:** Before ANY external communication, data handling, or credential use  
**Token cost:** ~250 tokens to load (should be cached)  
**Prerequisites:** None (foundational, always active)  
**When to load more:** Need credential management? Check scripts/utils/check_token_expiry.py | Need API audits? Run scripts/utils/audit_gmail_scopes.py
