...
**Load this when:** Analyzing candidate data and generating visualizations for reports  
**Token cost:** ~300 tokens to load + ~600 per analysis to execute  
**Prerequisites:** Database connection active, schema understood, matplotlib/charting libraries available  
**When to load more:** Need to query data? Load [database-queries.md](database-queries.md) | Need to embed in report? Load [report-generation.md](report-generation.md)
...
## Prerequisites
- MCP connection to the database must be active (see [database_connection.md](database_connection.md))
