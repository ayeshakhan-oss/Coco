...
**Load this when:** Setting up database access (one-time setup OR troubleshooting connection issues)  
**Token cost:** ~250 tokens to load  
**Prerequisites:** Database credentials, .env file created, MCP documentation  
**When to load more:** Need to query the DB? Load [database-queries.md](database-queries.md) | Need schema details? Load [docs/schema.md](../docs/schema.md)
