...
**Load this when:** Evaluating case study solutions and writing detailed assessment reports  
**Token cost:** ~350 tokens to load + ~1,200 per report to write  
**Prerequisites:** Case study from Markaz + Gmail, 8-step evaluation process, Noah Standard knowledge  
**When to load more:** Need candidate scorecard? Load [values-scorecard-scoring.md](values-scorecard-scoring.md) | Need to send case study? Load [email-notification.md](email-notification.md)
