...
export const MODULES: ModuleDef[] = [
  ...
  { slug: 'hiring-operations', label: 'Hiring Operations', icon: Building2, status: 'live', route: '/attendance', blurb: 'Daily attendance from Markaz leave records. Decision briefs are on the way.' },
