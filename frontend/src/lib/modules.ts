...
export const MODULES: ModuleDef[] = [
  ...
  { slug: 'candidate-evaluation', label: 'Candidate Evaluation', icon: FileSearch, status: 'live', route: '/evaluations', blurb: 'Screen CVs, score case studies, run values scorecards and read technical screening. Case study evaluation and KCD are on the way.' },
