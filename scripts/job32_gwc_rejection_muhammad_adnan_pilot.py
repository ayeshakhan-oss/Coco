...
# Email metadata
PILOT_MODE = False
TO = ["mohammadadnan786@hotmail.com"]
CC = ["hiring@taleemabad.com", "ayesha.khan@taleemabad.com", "sabeena.abbasi@taleemabad.com"]
SUBJECT = "When Maturity Meets a Different Kind of Hunger"
CANDIDATE_NAME = "Muhammad Adnan"
CANDIDATE_EMAIL = "mohammadadnan786@hotmail.com"
...
def send_pilot():
    ...
    try:
        ...
        safe_sendmail(
            ...
            context=f"job32_gwc_rejection_muhammad_adnan_live"
        )
