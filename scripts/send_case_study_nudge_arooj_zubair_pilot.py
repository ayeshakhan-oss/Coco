#!/usr/bin/env python3
"""
Case Study Reminder (gentle nudge) — Arooj Khali (Senior Manager Growth, app 3868)
+ Zubair Hussain (Growth Manager - Karachi, app 3792).
Context (verified in Markaz comm history 2026-08-10): Ayesha sent Arooj the SMG case
study Thu 2026-08-06 (23:24 PKT) and Zubair the GM case study Fri 2026-08-07
(21:59 PKT). Neither has submitted as of Mon 2026-08-10. Ayesha's brief: send reminders.
Design + wording: copied from approved scripts/send_case_study_nudge_gm_karachi_pilot.py
(locked interview-invite template FINAL_2026_05_13, no CTA button — reply-to-help flow).
Only per-candidate position + sent-day phrase differ.
...
# LIVE 2026-08-10: Ayesha approved Arooj ONLY. Zubair's nudge NOT approved yet —
# re-add his entry only when Ayesha says go.
CANDIDATES = [
    {"first": "Arooj", "full": "Arooj Khali", "email": "aroojkh.545@gmail.com",
     "position": "Senior Manager Growth", "sent_day": "last Thursday"},
    # {"first": "Zubair", "full": "Zubair Hussain", "email": "zubair.hafiz8@gmail.com",
    #  "position": "Growth Manager - Karachi", "sent_day": "on Friday"},
]
