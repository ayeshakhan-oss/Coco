#!/usr/bin/env python3
"""
Dummy Exploratory Call Invite — Demonstrates locked template format
Sends to Ayesha for design review before production use
"""
...
# Configuration
CANDIDATE_NAME = "Alex Richardson"
BOOKING_LINK = "https://calendar.app.google/r1Rj1b1UMiAqonDs5"
DOCUMENT_LINK = "https://drive.google.com/file/d/dummy-doc/view?usp=sharing"

PILOT_MODE = True
PILOT_TO = "ayesha.khan@taleemabad.com"

# Email addresses
TO = [PILOT_TO] if PILOT_MODE else ["alex.richardson@example.com"]
                            ...
                            <table width="775" bgcolor="#ffffff" cellpadding="0" cellspacing="0" border="0" style="width:775px; max-width:775px; margin:0 auto;">
                                ...
                                <tr>
                                    <td style="padding:44px 64px 52px 64px; text-align:left;">
                                        ...
                                        <p>
                                            I'm also attaching <a href="{DOCUMENT_LINK}">a brief overview</a> for additional context ahead of the conversation.
                                        </p>
...
def send_pilot():
    """Send dummy exploratory call invite to Ayesha"""
    load_dotenv()
    ...
    try:
        ...
        safe_sendmail(
            ...
            context="dummy_exploratory_call_invite_pilot"
        )

        server.quit()

        print("[SENT] Dummy exploratory call invite pilot to " + TO[0])
