"""I-10 Head Office Attendance Record — 14 April 2026 (Tuesday)"""
import os, sys, io
...
ONSITE = [
    "Salman Iqbal", "Zeeshan Zahoor", "Ayesha Raza Khan", "Javariya Mufarrakh",
    "Aymen Abid", "Ahsan Javed", "Taloot Ahmad Malik", "Ramsha Khurshid",
    "JAHAN ZAIB", "Zeshan Ali", "Amena Ahmed", "Usman Imtiaz",
    "Muhammad Zeeshan Usaid", "Ali Sipra", "Abdul Rehman Siddiqi", "Muhammad Umar Raza",
    "Abdul Rehman", "Muhammad Jalal Khan", "Mah Noor", "Hataf Bin Atif",
    "Mashhood Ali Rastgar", "Muhammad Raees Shujaan Azhar", "Ahmed Javed", "Haya Abid",
    "Sheikh Nimra Rasheed", "Saleh Muhammad", "Abdur Rehman", "Ramisha Riaz Sheikh",
    "Sabeen Fatima", "Laraib Sarfraz", "Hassan Shahzad", "Jahanzeb Ahmad",
    "Salman Ahmad", "Muhammad Hammad Sarfraz", "Osama Ahmad", "MUHAMMAD OMER MAZHAR RANA",
    "Iqra Zanib", "Muhammad Mehdi Abbas", "Babar Khan", "Fatima Khan", "Fatima Rahman",
    "Mahnoor Shafique", "Shoaib Ud Din", "Muhammad Kamran Taj", "Syed Junaid Ali Zaidi", "Rida Nayyab",
    "Saad Zahid", "Muhammad Haris", "Fahad Rao", "Muhammad Muzzammil Patel",
    "Muhammad Kamal", "Muhammad Usman Mughal", "MUHAMMAD SHOAIB KHAN"
]
# Remove Mahrah Ashraf (out sick per Teams)
ONSITE = [n for n in ONSITE if n != "Mahrah Ashraf"]
...
ON_LEAVE = [
    ...
    ("Mahrah Ashraf", "Sick Leave (Teams)"),
    ("Momina Tariq", "Half-day Leave — Exams (Apr 14 & 17), unavailable after 1pm"),
]

WFH_NO_MARKAZ = [
    ("Zunaira Shahid", "Not feeling well — WFH today (Teams update)"),
]
...
OUT_OF_OFFICE = []
ARCHIVED_NIETE = [
    ("Umama Gul Siddiqui", "NIETE — Archived/Parked · Onsite I-10"),
    ("Shumaila Aslam", "NIETE — Archived/Parked · Onsite I-10"),
    ("Jawwad Ali", "NIETE — Archived/Parked · Onsite I-10"),
    ("QURAT UL AIN", "NIETE — Archived/Parked · Not available second half (Teams)"),
    ("Hareem Fatima", "NIETE — Archived/Parked · Onsite I-10"),
    ("Momina Raja", "NIETE — Archived/Parked"),
...
PENDING_LEAVES = [
    ("Momna Tariq", "Grant (Education) — April 14 & 17 (Half-days, for exams)"),
    ("Muhammad Muzzammil Patel", "WFH — April 16"),
    ("Aroma Tahir", "WFH — April 30"),
    ("Ramsha Khurshid", "WFH — April 13"),
    ("Usman Imtiaz", "Annual — April 13"),
]
PARTIAL = [
    ("Afifa Sultana", "Will reach office by 12pm — Teams update"),
    ("Muhammad Saim", "Running a bit late — Teams update"),
    ("Muhammad Umar Raza", "Running a bit late — Teams update"),
    ("Hareem Fatima", "Running a bit late — Teams update"),
]
...
NEVER_FLAG = {"Alishba Anam", "Razia Kausar"}
...
if __name__ == "__main__":
    print("Building attendance report for 14 April 2026...")
    pdf = build_pdf()
    os.makedirs("output", exist_ok=True)
    pdf_path = "output/Attendance_14Apr2026.pdf"
