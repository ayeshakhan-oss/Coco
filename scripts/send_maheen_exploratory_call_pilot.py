#!/usr/bin/env python3
"""
Maheen Mirza — Exploratory Call Invite Pilot
Sends to Ayesha for approval before sending to candidate
"""
...
# Configuration
CANDIDATE_NAME = "Maheen Mirza"
CANDIDATE_EMAIL = "maheen.mirza06@gmail.com"
...
# Email addresses
TO = [PILOT_TO] if PILOT_MODE else [CANDIDATE_EMAIL]
...
def send_pilot():
    """Send Maheen's exploratory call invite pilot"""
    load_dotenv()
    ...
    try:
        ...
        safe_sendmail(
            ...
            context="maheen_mirza_exploratory_call_invite_pilot"
        )

        server.quit()

        print("[SENT] Maheen Mirza exploratory call invite pilot to " + TO[0])
