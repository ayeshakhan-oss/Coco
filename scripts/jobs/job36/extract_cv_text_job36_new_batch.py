"""
Extract CV text for Job 36 new batch (19 candidates applied Mar 11–28, 2026).
Saves text to output/cv_texts_job36_new_batch/ for manual screening.
"""
...
APP_IDS = [
    2124,  # Hafiza Iqra Bashir    — Islamabad
    2122,  # Ali Haider Baloch     — Islamabad
    2120,  # mashaldots            — LinkedIn temp
    2119,  # Hassan Tahir          — Islamabad
    2108,  # Hiba Ahmed            — Rawalpindi
    2106,  # Faris Meher Ali       — Lahore
    2105,  # Hamza Khan            — Islamabad
    2103,  # Attiqua Urfa          — Lahore
    2090,  # Mehreen Tariq         — Lahore (LUMS)
    2079,  # Umme Farwa            — Islamabad
    2072,  # luqmannaveed          — LinkedIn temp
    2061,  # Easha Imtiaz          — Lahore
    2053,  # Hamza Sattar          — Attock
    2050,  # Anosha Umer           — Lahore
    2043,  # faaiz                 — LinkedIn temp
    2040,  # romesa                — LinkedIn temp
    2029,  # Syed Muhammad Ali Abbas — Lahore (LUMS)
    2024,  # Mohid Naveed Sufi     — Peshawar
    2022,  # Maheen Sughra         — Islamabad
]

OUTPUT_DIR = "output/cv_texts_job36_new_batch"
...
def main():
    ...
    summary = []
    print(f"\n{'='*60}")
    print(f"Job 36 — New Batch CV Extraction ({len(rows)} candidates)")
    print(f"{'='*60}\n")
