...
JAWAD_BODY = (
    ...
    P("On <strong>Continuously Improve and Staying Curious</strong>, you spoke about your work with thoughtfulness, but when we asked about how you approach your own learning and how you help teams develop better ways of working together, the focus remained fairly static. Where we found questions was evidence of active curiosity, of identifying gaps and pursuing solutions, of bringing new approaches into how you and your team work. The engagement is genuine. The hunger to learn and improve continuously is what remained open in how you presented it.") +
