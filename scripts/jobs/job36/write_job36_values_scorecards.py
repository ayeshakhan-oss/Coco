"""
Write values scorecards for Nain Tara (app 1536) and Muhammad Junaid (app 1591)
...
SCORECARD_JUNAID = {
    ...
    "finalComments": "Junaid shows genuine commitment to continuous learning and field experience credibility — his MATLAB and World Bank training answers are his strongest moments. However three values came in at +/- and Practice Joy was a clear minus. The All for One and Don't Hold On Too Tight answers answered the structural shape of the question without the depth or stakes the value requires. Practice Joy had no example at all — just praise for Taleemabad. Result: OUT. 1 minus + 3 +/- exceeds threshold on both counts.",
...
SCORECARD_NAIN_TARA = {
    ...
    "values": [
        ...
        },
        {
            ...
            "curveBall": "Investor pivot scenario: At WWF, apricot harvesting product packaging was complete, contract fell through at final stage. Rather than abandoning the project, went back to market to find alternative buyers. Adapted without giving up. Strong adaptive response — shows flexibility in practice even if the primary example was weak.",
            "microCase": ""
        },
        {
            "name": "Practice Joy",
            "rating": "+",
            "deepDive": "Colleague Hussain lost his mother, returned to office grieving after 2-3 weeks. Nain Tara and the whole staff organised a small birthday celebration to rebuild his confidence and bring him back into the team. Specific, emotionally resonant, and real — demonstrates joy as a leadership tool, not just a personal mood. The closing ritual question drew a vague answer (she described her capabilities rather than a fun ritual), but the primary example is strong enough to carry the value.",
            "curveBall": "",
            "microCase": ""
        }
    ],
    "finalComments": "Nain Tara is a consistent, warm, and grounded candidate who cleared all six values comfortably. Her strongest moments: sacrificing her own proposal to help a fellow intern (V2), the Erasmus Mundus failure story (V3), and the birthday celebration for a grieving colleague (V6). The one +/- is Don't Hold On Too Tight — her primary example was circumstantial rather than deliberate, though the investor pivot scenario showed adaptability in practice. No minuses. Result: PASS. Advance to case study.",
...
def main():
    ...
    for u in UPDATES:
        ...
        print(f"Updated app {u['application_id']} ({u['scorecard']['candidateName']}) — {u['result'].upper()}")
