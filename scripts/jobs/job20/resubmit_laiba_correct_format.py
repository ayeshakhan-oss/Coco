"""
Resubmit Laiba Ahmad with EXACT format matching Meer Muneeb (boolean True for proceedToRightSeat)
"""
...
SCORECARD_LAIBA_AHMAD = {
    ...
    "proceedToRightSeat": True  # BOOLEAN, matching Meer's format exactly
}
...
print("[SUBMIT] Resubmitting Laiba Ahmad with correct format (proceedToRightSeat as boolean True)...")
cur.execute("""
    UPDATE applications
...
print("[OK] Laiba Ahmad scorecard submitted with correct format.")
conn.commit()
cur.close()
conn.close()
