...
# ══════════════════════════════════════════════════════════════════
# NO-HIRE CANDIDATES — all 27 assessed but eliminated (ranks 11–37)
# fields: rank, name, score, background, strength_note, reason, category
# ══════════════════════════════════════════════════════════════════
NO_HIRE_CANDIDATES = [
    # ── Sector-adjacent (programme delivery / compliance / reporting) ──
    {"rank": 11, "name": "Faheem Baig",          "score": 31, "background": "Programme Implementation, Development Sector",         "strength_note": "Development sector background; understands project delivery cycle",  "reason": "Programme implementation — not fundraising acquisition; no BD ownership evidenced",           "category": "Sector-Adjacent"},
    {"rank": 12, "name": "Hamdan Ahmad",          "score": 29, "background": "World Bank Programme Management",                     "strength_note": "World Bank-funded programme experience; donor compliance knowledge",  "reason": "Programme management on donor contracts — not frontline acquisition; no proposals won cited",  "category": "Sector-Adjacent"},
    {"rank": 13, "name": "Shakir Manzoor",        "score": 27, "background": "Fundraising Support Role, Development NGO",           "strength_note": "Worked in fundraising environment; exposure to grant processes",      "reason": "Supporting role — no evidence of independently owning acquisition pipeline or closing grants",  "category": "Sector-Adjacent"},
    {"rank": 14, "name": "Zubair Hussain",        "score": 26, "background": "Field Specialist, Development Sector",                "strength_note": "Field implementation experience; development sector familiarity",     "reason": "Field delivery role + salary anomaly (unusual figure entered); no fundraising track record",   "category": "Sector-Adjacent"},
    {"rank": 15, "name": "Abdul Salam",           "score": 24, "background": "WASH Sector Delivery",                               "strength_note": "Worked with donor-funded programmes in WASH",                        "reason": "WASH sector delivery — not fundraising acquisition; sector-pivot and function gap",           "category": "Sector-Adjacent"},
    # ── No impact ownership — relevant sector but no acquisition evidence ──
    {"rank": 16, "name": "Bareera Rauf",          "score": 23, "background": "Researcher / Development Sector",                     "strength_note": "Development research background; analytical skills",                 "reason": "Research function — no fundraising acquisition track record or donor pipeline ownership",      "category": "No Impact Ownership"},
    {"rank": 17, "name": "Samana Qaseem",         "score": 22, "background": "Alumni Relations & Admin, Education Sector",          "strength_note": "Education sector pedigree; alumni relationship management skills",  "reason": "Alumni/admin function — not fundraising acquisition; no grants won or pipeline evidenced",     "category": "No Impact Ownership"},
    # ── Wrong sector or geography ──
    {"rank": 18, "name": "Imran Haider",          "score": 21, "background": "Education Policy Analyst",                           "strength_note": "Education sector expertise; policy and government engagement",      "reason": "Policy analysis role — not BD/acquisition function; no donor relationships or proposals cited","category": "Wrong Sector / Geo"},
    {"rank": 19, "name": "Fahad Khan",            "score": 20, "background": "Hospital / Domestic Charity Fundraising",             "strength_note": "Fundraising function (domestic charity); proposal writing exposure",  "reason": "Domestic charity fundraising — no multilateral/bilateral (USAID/FCDO/WB) donor knowledge",    "category": "Wrong Sector / Geo"},
    {"rank": 20, "name": "Anita Kanwal",          "score": 19, "background": "Digital Charity Campaigns, UK-based",                "strength_note": "Fundraising function; digital campaign management experience",     "reason": "UK-based (no relocation mention = deal-breaker) + digital charity, not institutional donors", "category": "Wrong Sector / Geo"},
    {"rank": 21, "name": "Mahnoor Mellu",         "score": 18, "background": "SaaS / Tech Partnerships",                           "strength_note": "Partnerships and BD experience in commercial tech sector",           "reason": "Commercial SaaS partnerships — no institutional donor fundraising or NGO experience",          "category": "Wrong Sector / Geo"},
    # ── Junior profile ──
    {"rank": 22, "name": "Muhammad Ali Zafar",    "score": 17, "background": "Research Intern",                                     "strength_note": "Academic/research interest in development sector",                  "reason": "Research intern level — too junior for Year-1 $500K+ acquisition mandate",                    "category": "Junior Profile"},
    {"rank": 23, "name": "Zainab",                "score": 16, "background": "Early-Career HR Generalist",                         "strength_note": "Generalist people skills; some comms exposure",                     "reason": "Early-career HR — no fundraising background; significant ramp-up required",                   "category": "Junior Profile"},
    # ── Unrelated professional background ──
    {"rank": 24, "name": "Syeda Kainat",          "score": 15, "background": "M&E / Communications, Development Sector",           "strength_note": "Development sector exposure; M&E and comms skills",                "reason": "M&E and communications — adjacent but not acquisition; no BD or donor relations ownership",    "category": "Unrelated Background"},
    {"rank": 25, "name": "Sameen Amjad Ali",      "score": 13, "background": "Marketing / Communications",                         "strength_note": "Strong comms and content skills",                                   "reason": "Marketing/comms background — no institutional donor fundraising or NGO ecosystem experience",  "category": "Unrelated Background"},
    {"rank": 26, "name": "Hasan Shahid",          "score": 12, "background": "Digital Marketing",                                  "strength_note": "Digital outreach skills; some audience engagement experience",      "reason": "Digital marketing — no connection to institutional fundraising or development donors",          "category": "Unrelated Background"},
    {"rank": 27, "name": "Muhammad Taqi",         "score": 11, "background": "SaaS Sales",                                         "strength_note": "Sales pipeline management; closing experience in commercial sector","reason": "SaaS/commercial sales — no NGO or donor ecosystem experience; sector gap is fundamental",      "category": "Unrelated Background"},
    {"rank": 28, "name": "Muhammad Sumraiz Kundi","score": 10, "background": "Telecom Sales",                                      "strength_note": "Sales experience; negotiation skills",                              "reason": "Telecom sales — no fundraising, NGO, or development sector background",                       "category": "Unrelated Background"},
    {"rank": 29, "name": "Asim Ur Rehman",        "score":  9, "background": "Rural Volunteer Work",                               "strength_note": "Community engagement; grassroots development awareness",            "reason": "Volunteer work only — no professional fundraising or donor relations experience",              "category": "Unrelated Background"},
    {"rank": 30, "name": "Sheraz Khan",           "score":  8, "background": "Microsoft Licensing / IT Sales",                     "strength_note": "Commercial deal-closing; tech sector experience",                  "reason": "IT/licensing — no connection to fundraising, NGOs, or institutional donors",                   "category": "Unrelated Background"},
    {"rank": 31, "name": "Muhammad Akmal",        "score":  7, "background": "Administration",                                     "strength_note": "Organisational and coordination skills",                           "reason": "Administrative background — no fundraising or donor relations experience",                     "category": "Unrelated Background"},
    {"rank": 32, "name": "Laveeza Shah",          "score":  6, "background": "Human Resources",                                    "strength_note": "People management; organisational understanding",                   "reason": "HR function — no institutional fundraising or NGO ecosystem background",                       "category": "Unrelated Background"},
    {"rank": 33, "name": "Arooj Irfan",           "score":  5, "background": "Clinical Psychologist",                              "strength_note": "Strong analytical and communication skills",                        "reason": "Clinical psychology — completely unrelated to fundraising/partnerships mandate",               "category": "Unrelated Background"},
    {"rank": 34, "name": "Moeen Hassan",          "score":  4, "background": "AutoCAD / Real Estate",                              "strength_note": "Technical precision; project planning skills",                      "reason": "AutoCAD/real estate — completely unrelated to fundraising or development sector",              "category": "Unrelated Background"},
    {"rank": 35, "name": "Aqsa Gul",             "score":  3, "background": "Customer Service",                                   "strength_note": "Client communication and stakeholder engagement",                   "reason": "Customer service — no fundraising, NGO, or donor relations background",                        "category": "Unrelated Background"},
    {"rank": 36, "name": "Sani Muhammad",         "score":  2, "background": "IT Operations",                                      "strength_note": "Technical problem-solving; systems management",                     "reason": "IT operations — completely unrelated to fundraising/partnerships mandate",                     "category": "Unrelated Background"},
]
...
<!-- ══════════════════════════════════════════════════════════════
     SECTION 3: DEEP COMPARATIVE ANALYSIS — ALL CANDIDATES
═══════════════════════════════════════════════════════════════ -->
<h2 style="color:#6B21A8;border-bottom:3px solid #EC4899;padding-bottom:6px;margin-top:40px;font-size:18px;">&#51;&#65039;&#8419; Deep Comparative Analysis</h2>
<p style="font-size:12px;color:#6B7280;margin-bottom:4px;">All 48 applicants ranked #1 (strongest fit) to #36+ (no-hire). Tiers: <b style="color:#16A34A;">Tier&nbsp;A&nbsp;85+</b> &bull; <b style="color:#1D4ED8;">Tier&nbsp;B&nbsp;70&ndash;84</b> &bull; <b style="color:#D97706;">Tier&nbsp;C&nbsp;55&ndash;69</b> &bull; <b style="color:#6B7280;">Extended&nbsp;Review&nbsp;&lt;55</b> &bull; <b style="color:#374151;">No-Hire&nbsp;&lt;35</b>. Part A = master ranking table (all candidates, with experience column). Part B = compact profiles for all no-hire candidates (Ranks #11&ndash;#36), grouped by elimination reason.</p>
"""
...
html += """
  <tr>
    <td colspan="11" bgcolor="#374151" style="background-color:#374151;color:#fff;font-weight:bold;font-size:11px;padding:6px 8px;text-align:center;">
      &#8212; NO-HIRE CANDIDATES (Ranks #11&ndash;#36) &mdash; Assessed but did not meet JD threshold &#8212;
    </td>
  </tr>"""
...
for n in NO_HIRE_CANDIDATES:
  ...
  <tr bgcolor="{bg}" style="background-color:{bg};">
    ...
    <td style="font-size:10px;text-align:center;color:#6B7280;">{NH_EXP.get(n["name"], "&mdash;")}</td>
    <td style="font-size:10px;color:#6B7280;font-style:italic;">{n["background"]}</td>
    <td style="font-size:10px;color:#9CA3AF;">{NH_ORG_SIGNAL.get(n["name"], "&mdash;")}</td>
...
html += """
  <tr bgcolor="#F9FAFB" style="background-color:#F9FAFB;">
    <td style="text-align:center;color:#9CA3AF;">37+</td>
    <td style="color:#9CA3AF;font-style:italic;">9 applicants — No CV submitted</td>
    ...
    <td colspan="7" style="font-size:10px;color:#9CA3AF;">LinkedIn Quick Apply with no CV attached. Apps: 1332, 1336, 1348, 1350, 1366, 1372, 1386, 1407, 1515. Cannot be assessed.</td>
  </tr>
  <tr bgcolor="#F3F4F6" style="background-color:#F3F4F6;">
    <td style="text-align:center;color:#9CA3AF;">&mdash;</td>
    <td style="color:#9CA3AF;font-style:italic;">2 applicants — Excluded</td>
    <td style="text-align:center;color:#9CA3AF;">N/A</td>
    <td bgcolor="#9CA3AF" style="background-color:#9CA3AF;color:#fff;text-align:center;font-size:10px;">Excluded</td>
    <td colspan="7" style="font-size:10px;color:#9CA3AF;">AAMIR SOHAIL (1393) &mdash; salary &ldquo;1&rdquo;, junk entry &bull; Danish Hussain (1347) &mdash; duplicate of application 1346</td>
  </tr>
</table>
<p style="font-size:10px;color:#6B7280;margin:2px 0 20px 0;">&#128269; = OCR-recovered CV &bull; <b>Bold rows</b> = Tier A/B/C shortlist &bull; Scores for Ranks #11&ndash;#36 are calibrated estimates based on CV evidence and 7-dimension framework.</p>
"""

# ── Part B: Detailed Profiles — Shortlist & Extended Review (#1–#10) ──────────────────
html += """
<h3 style="color:#6B21A8;margin-top:28px;margin-bottom:8px;font-size:15px;">Part B &mdash; Detailed Profiles &mdash; Shortlist &amp; Extended Review (#1&ndash;#10)</h3>
<p style="font-size:12px;color:#6B7280;margin-bottom:16px;">Full evidence-based profile for every shortlisted and extended-review candidate. Includes USP, dimension scores, key strengths, risks, org signals, CV quality, and interview questions.</p>
"""

for c in CANDIDATES:
    budget_pill = f'<span style="background:{c["budget_color"]};color:{c["budget_text_color"]};font-weight:bold;padding:2px 8px;border-radius:10px;font-size:11px;">{c["budget_label"]}{" &nbsp;&bull;&nbsp; " + c["budget_gap"] if c.get("budget_gap") else ""}</span>'
    org_html = "".join(f'<div style="font-size:11px;color:#374151;margin:2px 0;">&#9679; <b>{st}</b> &mdash; {sd}</div>' for st, sd in c["org_signals"]) or '<div style="font-size:11px;color:#9CA3AF;">No notable org signals</div>'
    dim_cmap = {4:"#16A34A",3:"#22C55E",2:"#EAB308",1:"#F97316",0:"#DC2626"}
    dim_cells = "".join(f'<td style="text-align:center;background:{dim_cmap.get(s,"#9CA3AF")};color:#fff;font-weight:bold;padding:4px 7px;font-size:10px;">{s}</td>' for s in c["dims"])
    str_html  = "".join(f'<li style="margin:3px 0;font-size:12px;">{s}</li>' for s in c["strengths"])
    risk_html = "".join(f'<li style="margin:3px 0;font-size:12px;color:#991B1B;">{r}</li>' for r in c["risks"])
    iq_html   = "".join(f'<li style="margin:3px 0;font-size:12px;">{q}</li>' for q in c["interview_qs"])
    mh_badge  = f' <span style="background:#FEF3C7;color:#92400E;font-size:10px;font-weight:bold;padding:1px 6px;border-radius:8px;">&#9888; {c["missing_mh"]} missing must-have</span>' if c.get("missing_mh", 0) > 0 else ""
    ocr_badge = ' <span style="background:#EDE9FE;color:#5B21B6;font-size:10px;padding:1px 5px;border-radius:6px;">&#128269; OCR</span>' if c.get("ocr") else ""
    verdict_v = VERDICT.get(c["name"], "&mdash;")
    vl = verdict_v.lower()
    vbg = "#D1FAE5" if "immediately" in vl else ("#FEF3C7" if any(x in vl for x in ["sign-off","hold","pipeline"]) else "#FEE2E2")
    vtc = "#065F46" if "immediately" in vl else ("#92400E" if any(x in vl for x in ["sign-off","hold","pipeline"]) else "#991B1B")
    cqcolor = quality_colors.get(c["cv_quality"], "#6B7280")
    html += f"""
<div style="background:#FAFAFA;border:1px solid #E5E7EB;border-left:5px solid {c['tier_color']};border-radius:6px;padding:14px 16px;margin-bottom:20px;">
  <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>
    <td><span style="font-size:16px;font-weight:bold;color:{c['tier_color']};">#{c['rank']} {c['name']}</span>{ocr_badge}{mh_badge}
      <span style="font-size:11px;color:#6B7280;margin-left:8px;">{c['current_role']}</span></td>
    <td style="text-align:right;white-space:nowrap;">
      <span style="background:{c['tier_color']};color:#fff;font-weight:bold;font-size:14px;padding:3px 10px;border-radius:8px;">{c['score']}</span>
      <span style="font-size:12px;color:{c['tier_color']};font-weight:bold;margin-left:6px;">{c['tier']}</span>&nbsp;&nbsp;{budget_pill}
    </td>
  </tr></table>
  <div style="background:{vbg};color:{vtc};font-weight:bold;font-size:12px;padding:5px 10px;border-radius:4px;margin:8px 0 4px 0;">&#9654; Verdict: {verdict_v}</div>
  <div style="background:#EDE9FE;border-left:4px solid #7C3AED;padding:8px 10px;margin:8px 0;font-size:12px;"><b>USP:</b> {c['usp']}</div>
  <table border="0" cellpadding="0" cellspacing="2" style="margin:6px 0;"><tr>
    <td style="font-size:10px;color:#6B7280;padding-right:6px;vertical-align:middle;">Dimensions&nbsp;(0&ndash;4):</td>
    {dim_cells}
    <td style="font-size:9px;color:#6B7280;padding-left:8px;vertical-align:middle;">D1=Functional&nbsp;&middot;&nbsp;D2=Outcomes&nbsp;&middot;&nbsp;D3=Env&nbsp;&middot;&nbsp;D4=Ownership&nbsp;&middot;&nbsp;D5=Stakeholder&nbsp;&middot;&nbsp;D6=Skills&nbsp;&middot;&nbsp;D7=Growth</td>
  </tr></table>
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:8px 0;"><tr>
    <td width="50%" valign="top" style="padding-right:8px;">
      <b style="font-size:12px;color:#065F46;">&#10003; Key Strengths</b>
      <ul style="margin:4px 0 0 14px;padding:0;">{str_html}</ul>
    </td>
    <td width="50%" valign="top" style="padding-left:8px;border-left:1px solid #E5E7EB;">
      <b style="font-size:12px;color:#991B1B;">&#9888; Key Risks / Gaps</b>
      <ul style="margin:4px 0 0 14px;padding:0;">{risk_html}</ul>
    </td>
  </tr></table>
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:6px 0;"><tr>
    <td width="60%" valign="top">
      <b style="font-size:11px;color:#374151;">Org Signals:</b><br>{org_html}
    </td>
    <td width="40%" valign="top" style="padding-left:8px;border-left:1px solid #E5E7EB;">
      <b style="font-size:11px;color:#374151;">CV Quality:</b>
      <span style="color:{cqcolor};font-weight:bold;font-size:12px;"> {c['cv_quality']}</span><br>
      <span style="font-size:11px;color:#6B7280;">{c['cv_quality_note']}</span>
    </td>
  </tr></table>
  <details style="margin-top:8px;"><summary style="cursor:pointer;font-size:12px;font-weight:bold;color:#6B21A8;padding:4px 0;">&#9660; Interview Questions</summary>
    <ol style="margin:6px 0 0 16px;padding:0;">{iq_html}</ol>
  </details>
  <div style="font-size:11px;color:#6B7280;margin-top:6px;border-top:1px solid #E5E7EB;padding-top:6px;">
    Experience: <b>{c['total_exp']}</b> total &nbsp;&#183;&nbsp; Relevant: <b>{c['relevant_exp']}</b> &nbsp;&#183;&nbsp; Salary: <b>{c['salary']}</b> &nbsp;&#183;&nbsp; Confidence: <b style="color:{c['tier_color']};">{c['confidence']}</b>
  </div>
</div>"""

# ── Part C: No-Hire Compact Profiles (#11–#36) ────────────────────────────────────────
html += """
<h3 style="color:#6B21A8;margin-top:28px;margin-bottom:8px;font-size:15px;">Part C &mdash; No-Hire Profiles (#11&ndash;#36)</h3>
<p style="font-size:12px;color:#6B7280;margin-bottom:12px;">All 26 eliminated candidates reviewed and grouped by elimination reason. Includes what was positive about each profile and the specific disqualifying gap.</p>
"""

CATEGORIES_ORDER = ["Sector-Adjacent","No Impact Ownership","Wrong Sector / Geo","Junior Profile","Unrelated Background"]
CAT_COLORS = {"Sector-Adjacent":"#1D4ED8","No Impact Ownership":"#D97706","Wrong Sector / Geo":"#7C3AED","Junior Profile":"#0891B2","Unrelated Background":"#6B7280"}
CAT_NOTES = {
    "Sector-Adjacent":      "Right ecosystem, wrong function. Worked in development sector but in programme delivery, compliance, or M&amp;E &mdash; not donor acquisition or business development.",
    "No Impact Ownership":  "Adjacent function but no evidence of owning an acquisition pipeline or independently closing institutional grants.",
    "Wrong Sector / Geo":   "Fundraising function confirmed but wrong sector (domestic charity, digital, WASH) or wrong geography (abroad with no relocation stated).",
    "Junior Profile":       "Correct direction but insufficient experience for a Year-1 $500K+ acquisition mandate.",
    "Unrelated Background": "No connection to institutional fundraising, NGO ecosystem, or development donors.",
}

for cat in CATEGORIES_ORDER:
    group = [n for n in NO_HIRE_CANDIDATES if n["category"] == cat]
    if not group:
        continue
    cc = CAT_COLORS[cat]
    cn = CAT_NOTES[cat]
    html += f"""<div style="margin-bottom:18px;">
<div style="background:{cc};color:#fff;font-weight:bold;font-size:12px;padding:5px 10px;border-radius:4px 4px 0 0;">&#9654; {cat} &mdash; {len(group)} candidate{"s" if len(group)!=1 else ""}</div>
<div style="font-size:11px;color:#6B7280;background:#F9FAFB;padding:6px 10px;border-left:3px solid {cc};border-right:1px solid #E5E7EB;">{cn}</div>
<table width="100%" border="1" cellpadding="6" cellspacing="0" style="border-collapse:collapse;border-color:#E5E7EB;font-size:11px;margin-top:0;">
  <tr bgcolor="#F3F4F6" style="background-color:#F3F4F6;">
    <th style="width:4%;text-align:center;">#</th>
    <th>Name</th>
    <th>Background &amp; Org Signal</th>
    <th style="color:#065F46;">What Was Good</th>
    <th style="color:#991B1B;">Why Not Progressed</th>
  </tr>"""
    for n in group:
        nh_org = NH_ORG_SIGNAL.get(n["name"], "")
        org_cell = f'{n["background"]}<br><span style="color:#9CA3AF;font-size:10px;">{nh_org}</span>' if nh_org else n["background"]
        html += f"""
  <tr bgcolor="#ffffff" style="background:#fff;">
    <td style="text-align:center;color:#9CA3AF;">#{n['rank']}</td>
    <td><b>{n['name']}</b><br><span style="color:#9CA3AF;font-size:10px;">{NH_EXP.get(n["name"],"&mdash;")} exp</span></td>
    <td style="font-style:italic;color:#6B7280;">{org_cell}</td>
    <td style="color:#065F46;">{n['strength_note']}</td>
    <td style="color:#991B1B;">{n['reason']}</td>
  </tr>"""
    html += "\n</table></div>"

html += """
<!-- ── Charts: Score Comparison + Dimension Radar ── -->
<h2 style="color:#6B21A8;border-bottom:3px solid #EC4899;padding-bottom:6px;margin-top:32px;font-size:18px;">&#53;&#65039;&#8419; Visual Analytics &mdash; Charts</h2>
...
<!-- ══════════════════════════════════════════════════════════════
     SECTION 4: STRONG MATCH BUT OUT OF BUDGET
═══════════════════════════════════════════════════════════════ -->
<h2 style="color:#6B21A8;border-bottom:3px solid #EC4899;padding-bottom:6px;margin-top:40px;font-size:18px;">&#52;&#65039;&#8419; Strong Match but Out of Budget</h2>
...
<!-- ══════════════════════════════════════════════════════════════
     SECTION 5: VISUAL ANALYTICS
═══════════════════════════════════════════════════════════════ -->
<h2 style="color:#6B21A8;border-bottom:3px solid #EC4899;padding-bottom:6px;margin-top:40px;font-size:18px;">&#53;&#65039;&#8419; Visual Analytics</h2>
...
═══════════════════════════════════════════════════════════════ -->
<h2 style="color:#6B21A8;border-bottom:3px solid #EC4899;padding-bottom:6px;margin-top:40px;font-size:18px;">&#54;&#65039;&#8419; Why Others Did Not Make the Cut</h2>
<p style="font-size:12px;color:#6B7280;margin-bottom:12px;">Summary of elimination reasons (see Section 3 Part C for individual profiles of all 26 no-hire candidates). Every candidate was reviewed in full &mdash; these decisions reflect JD evidence, not assumptions.</p>
...
with smtplib.SMTP_SSL("smtp.gmail.com", 465) as server:
    ...
    allow_candidate_addresses(RECIPIENT if isinstance(RECIPIENT, list) else [RECIPIENT])
        safe_sendmail(server, SENDER, RECIPIENT, msg.as_string(), context='send_job32_report_v9')
