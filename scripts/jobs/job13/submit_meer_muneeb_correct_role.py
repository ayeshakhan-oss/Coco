"""
Remove Meer Muneeb scorecard from Full Stack Lead (job 24, app 677)
Submit scorecard to Full Stack Developer (job 13, app 2969)
...
def main():
    ...
    # Step 1: Clear scorecard from Full Stack Lead (app 677)
    print("[STEP 1] Removing scorecard from Full Stack Lead (app 677)...")
    cur.execute("""
        UPDATE applications
        SET values_scorecard = NULL,
        ...
        WHERE id = 677
    """)
    print("[OK] Cleared app 677")

    # Step 2: Submit to Full Stack Developer (app 2969)
    print("[STEP 2] Submitting scorecard to Full Stack Developer (app 2969)...")
    cur.execute("""
        UPDATE applications
        ...
        WHERE id = %s
    """, (
        json.dumps(SCORECARD_MEER_MUNEEB),
        "pass",
        interview_date,
        "Ayesha Khan",
        "Right Seat",
    ...
    print(f"[OK] Submitted scorecard to app 2969 (Full Stack Developer)")

    conn.commit()
    cur.close()
    conn.close()
    print("[OK] Complete: Meer Muneeb scorecard moved to correct role.")
