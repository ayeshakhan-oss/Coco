#!/usr/bin/env python3
"""
Case Study Debrief Invites - Senior Manager Growth (Job 42), BATCH 2 of 6 (2026-08-31).
Skill 06 type #2. Locked invite design (FINAL_2026_05_13). Body copy cloned VERBATIM from
the 2026-08-18 SMG batch-1 live send - only the candidate list and booking link changed.

Ayesha's brief 2026-08-31: invite the candidates from the NEW batch (rounds 2-4 of the
case-study evaluation, consolidated report piloted 31 Aug 02:33) who scored above 70.
Booking link https://calendar.app.google/VXJ1qxddrMVakeFAA supplied by her.

VERIFIED before drafting:
  - Scores from the consolidated 9-candidate report: Khushal 98 / Furqan 93 / Hania 90 /
    Vaneeza 82 / Shafaq 75 / Lamis 73 are the six above 70. Below the line and NOT invited:
    Kanooz Siddiqui 62 (borderline), Ali Wajdan Khan 49, Rimsha Taj 45.
  - Emails + app IDs pulled from Markaz/Neon 2026-08-31, not reused from any earlier list.
  - NO debrief invite has ever been sent to any of the six (per-recipient IMAP scan of
    ayesha.khan@ Sent Mail): they have values invites, appointment-booked notices, and for
    Furqan the case-study dispatch thread. No debrief.
  - NAME CONFLICTS resolved from the candidates' own evidence, not from Markaz:
      * Markaz says "Khushal Khan" (and his CV filename does too), but he signs himself
        "Khushal Kakar" in all three of his own emails, including 30 Aug. Using KAKAR.
        >>> FLAGGED TO AYESHA - confirm before live. <<<
      * Markaz + his own CV filename say "Vaneeza...Baig" while his/her Gmail display name
        reads "Veniza Baig". Two self-entered sources beat a display name -> VANEEZA.
  - BOOKING_LINK supplied directly by Ayesha 2026-08-31 - not fabricated, not reused from
    the batch-1 schedule (that was calendar.app.google/we2Xc2uoYA1x3c1s9).
...
PILOT_MODE = False  # LIVE - approved by Ayesha 2026-08-31 ("GO LIVE"), CC list confirmed by her
PILOT_TO = "ayesha.khan@taleemabad.com"
# CC confirmed by Ayesha 2026-08-31 ("youre right about the cc list") - same as batch 1.
...
BOOKING_LINK = "https://calendar.app.google/VXJ1qxddrMVakeFAA"  # supplied by Ayesha 2026-08-31
...
CANDIDATES = [
    {"first": "Khushal", "full": "Khushal Kakar", "email": "khusshaal@gmail.com"},          # 98 app 4134
    {"first": "Furqan", "full": "Furqan Afzal", "email": "fafzal98@gmail.com"},             # 93 app 4145
    {"first": "Hania", "full": "Hania Khan", "email": "hania.thekhan@gmail.com"},           # 90 app 4035
    {"first": "Vaneeza", "full": "Vaneeza Tashfeen Baig", "email": "veniza.baig@gmail.com"},# 82 app 4033
    {"first": "Shafaq", "full": "Shafaq Syed", "email": "shafaqsyed5@gmail.com"},           # 75 app 4137
    {"first": "Lamis", "full": "Lamis Maniar", "email": "lamis.maniar@gmail.com"},          # 73 app 4062
]
