#!/usr/bin/env python3
"""
Values Interview Invite — Growth Manager - Karachi, Batch 2 (2026-08-04).
...
# Shortlisted on job 41 with no values interview (verified in Markaz 2026-08-04).
# App 3871 ("Ayesha Khan", ayesha.khan@taleemabad.com) EXCLUDED - test record.
CANDIDATES = [
    {"first": "Yashfeen", "full": "Yashfeen Zahid", "email": "yashfeen_zahid02@outlook.com"},
    ...
    {"first": "Huzaifa", "full": "Muhammad Huzaifa Wakil", "email": "huzaifahwakil@gmail.com"},
    {"first": "Masooma", "full": "Syeda Masooma Asif", "email": "S.MasoomaAsif@gmail.com"},
    ...
    if PILOT_MODE:
        for c in CANDIDATES:
            ...
            safe_sendmail(server, SENDER, recipients, msg.as_string(),
                          context=f"PILOT values invite GM-Karachi batch2 ({c['full']}) to Ayesha only")
        ...
        for c in CANDIDATES:
            ...
            safe_sendmail(server, SENDER, recipients, msg.as_string(),
                          context=f"LIVE values invite GM-Karachi batch2 -> {c['full']}")
