#!/usr/bin/env python3
"""
Case Study Debrief Invite — Waqas Hassan, Growth Manager - Karachi (2026-08-07).
Skill 06 type #2. Locked invite design (FINAL_2026_05_13). Cloned from the approved
GM-Lahore debrief script; position + candidate changed. Booking link: same appointment
schedule Ayesha provided for the GM debriefs 2026-08-07 (flagged in pilot for her review).

Submission verified via Gmail 2026-08-07 (dual-source rule): he submitted BY EMAIL -
"Re: Lets proceed with the Case Study for Growth Manager - Waqas" at 14:46, after two
replies to the Aug-6 nudge. Markaz app 3870 case_study fields still empty (email path).
"""
import os
import sys
import smtplib
