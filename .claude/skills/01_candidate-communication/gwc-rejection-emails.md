...
- Candidate participated in GWC conversation/interview
- Candidate was NOT selected for the role
- GWC scorecard data available (Get It, Want It, Capacity ratings)
- Email must be warm, supportive, and based on scorecard evidence only
...
|---------|---|---|
| Fabricated details | Goes beyond scorecard data | Use ONLY scorecard information |
| Used internal jargon | "GWC" visible to candidate | Use warm, accessible language |
| Harsh tone | "You failed / you don't understand" | Frame as mentoring, not judgment |
| Em dashes in body | Looks AI-generated | Replace with period, comma, or colon |
| "I" voice | Breaks consistency | Use "we" (team decision) |
